...
ADD Makefile zookeeper.logrotate zookeeper.service zookeeper.spec zookeeper.sysconfig zookeeper.log4j.properties zookeeper.log4j-cli.properties zoo.cfg /root/
